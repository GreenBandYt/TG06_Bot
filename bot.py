...
async def send_start(message: Message):
    await message.answer("Добро пожаловать! Я ваш помощник в экономике! Выберите интересующую вас категорию", reply_markup=keyboard)
    #await FinancesForm.category1.set()
...
async def exchange_rates(message: Message):
    url = "https://v6.exchangerate-api.com/v6/ea3dbc161bf342f1eef61097/latest/USD"
    try:
